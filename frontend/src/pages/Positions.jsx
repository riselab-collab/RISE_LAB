            ...
            >
              ...
              <div className="bg-indigo-50 p-4 rounded-lg border border-indigo-100">
                <p className="text-slate-800 font-medium">
                  Interested students may write to <a href="mailto:lava@iitrpr.ac.in" className="text-[#FF6600] underline hover:text-black">lava@iitrpr.ac.in</a> with a detailed Curriculum Vitae, a research proposal (at least two pages), and a motivation letter.
                </p>
              </div>
            </PositionSection>
